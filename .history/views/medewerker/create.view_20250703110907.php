...
<main>
  ...
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="/show/medewerker" method="POST">
        <div>
          ...
          <?php if (isset($errors['first'])): ?>
            <p class="text-red-500 text-s mt-1 mb-1"><?= $errors['first'] ?></p>
          <?php endif ?>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            ...
            <?php if (isset($errors['last'])): ?>
              <p class="text-red-500 text-s mt-1 mb-1"><?= $errors['last'] ?></p>
            <?php endif ?>
          </div>
        ...
        <div>
          ...
          $types = [
            ...
            'VootstelManager' => 'VootstelManager'
          ];
          $selected = $_POST['type'] ?? '';
          ?>
          <div class="mb-6">
