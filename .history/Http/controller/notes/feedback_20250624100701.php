...
try {
    ...
    // Voeg de melding toe
    $db->query('INSERT INTO feedback (MeldingId, Nummer, Bericht, Isactief, Opmerking, Datumaangemaakt, Datumgewijzigd)
VALUES (:MeldingId, :Nummer, :Bericht, 1, NULL, NOW(), NOW())', [
        'MeldingId' => $meldingId,  // Dit moet verwijzen naar een bestaande melding
        'Nummer' => $nieuwNummer,
        'Bericht' => $bericht
    ]);
    // Redirect
